...
13. **IMPORTANTE:** Debemos quitar el acceso y permisos del service account de Pachyderm que pusimos en el bucket `demo_espacial` en GCP, donde tragimos los datos inciales para el repositorio de entrada `shapes_sp`.
