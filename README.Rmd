...
Este repositorio contiene el material para el taller Data Pipelines at scale 
with R and Kubernetes a impartir durante la conferencia [UseR! 2021](https://user2021.r-project.org/)
